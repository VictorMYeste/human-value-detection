...
echo "=========="
echo "----- Predicting Test -----"
python3 predict.py --test-dataset ../../data/test-english/ --model-name Baseline --filter-1-dir ../social-vs-personal-focus/output/ --filter-1-model NER --filter-1-th 0.19
echo "----- Evaluating Test -----"
...
echo "=========="
echo "----- Predicting Test -----"
python3 predict.py --test-dataset ../../data/test-english/ --model-name Baseline --filter-1-dir ../social-vs-personal-focus/output/ --filter-1-model Lex-Schwartz --filter-1-th 0.21
echo "----- Evaluating Test -----"
...
echo "=========="
echo "----- Predicting Test -----"
python3 predict.py --test-dataset ../../data/test-english/ --model-name Baseline --filter-1-dir ../social-vs-personal-focus/output/ --filter-1-model Lex-WorryWords --filter-1-th 0.21
echo "----- Evaluating Test -----"
...
echo "=========="
echo "----- Predicting Test -----"
python3 predict.py --test-dataset ../../data/test-english/ --model-name Baseline --filter-1-dir ../social-vs-personal-focus/output/ --filter-1-model Lex-LIWC --filter-1-th 0.17
echo "----- Evaluating Test -----"
...
echo "=========="
echo "----- Predicting Test -----"
python3 predict.py --test-dataset ../../data/test-english/ --model-name Baseline --filter-1-dir ../social-vs-personal-focus/output/ --filter-1-model TD-NMF --filter-1-th 0.2
echo "----- Evaluating Test -----"
...
echo "=========="
echo "----- Predicting Test -----"
python3 predict.py --test-dataset ../../data/test-english/ --model-name Baseline --filter-1-dir ../social-vs-personal-focus/output/ --filter-1-model TD-BERTopic --filter-1-th 0.22
echo "----- Evaluating Test -----"
...
echo "=========="
echo "----- Predicting Test -----"
python3 predict.py --test-dataset ../../data/test-english/ --model-name Lex-MJD --lexicon MJD --filter-1-dir ../social-vs-personal-focus/output/ --filter-1-model NER --filter-1-th 0.19
echo "----- Evaluating Test -----"
...
echo "=========="
echo "----- Predicting Test -----"
python3 predict.py --test-dataset ../../data/test-english/ --model-name Lex-MJD --lexicon MJD --filter-1-dir ../social-vs-personal-focus/output/ --filter-1-model Lex-Schwartz --filter-1-th 0.21
echo "----- Evaluating Test -----"
...
echo "=========="
echo "----- Predicting Test -----"
python3 predict.py --test-dataset ../../data/test-english/ --model-name Lex-MJD --lexicon MJD --filter-1-dir ../social-vs-personal-focus/output/ --filter-1-model Lex-WorryWords --filter-1-th 0.21
echo "----- Evaluating Test -----"
...
echo "=========="
echo "----- Predicting Test -----"
python3 predict.py --test-dataset ../../data/test-english/ --model-name Lex-MJD --lexicon MJD --filter-1-dir ../social-vs-personal-focus/output/ --filter-1-model Lex-LIWC --filter-1-th 0.17
echo "----- Evaluating Test -----"
...
echo "=========="
echo "----- Predicting Test -----"
python3 predict.py --test-dataset ../../data/test-english/ --model-name Lex-MJD --lexicon MJD --filter-1-dir ../social-vs-personal-focus/output/ --filter-1-model TD-NMF --filter-1-th 0.2
echo "----- Evaluating Test -----"
...
echo "=========="
echo "----- Predicting Test -----"
python3 predict.py --test-dataset ../../data/test-english/ --model-name Lex-MJD --lexicon MJD --filter-1-dir ../social-vs-personal-focus/output/ --filter-1-model TD-BERTopic --filter-1-th 0.22
echo "----- Evaluating Test -----"

...
echo "=========="
echo "===== Baseline (based on Self-Protection = Baseline) ====="
echo "=========="
...
echo "=========="
echo "----- Predicting Test -----"
python3 predict.py --test-dataset ../../data/test-english/ --model-name Baseline --filter-1-dir ../growth-vs-self-protection/output/ --filter-1-model Baseline --filter-1-th 0.1
echo "----- Evaluating Test -----"
python3 eval.py --test-dataset ../../data/test-english/ --model-name Baseline --filter-1-model Baseline --filter-1-th 0.1
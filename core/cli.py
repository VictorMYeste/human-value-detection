...
def parse_args(prog_name) -> argparse.Namespace:
    ...
    cli.add_argument("-e", "--test-dataset", default=None, help="Path to test dataset")
    cli.add_argument("-od", "--output-directory", default="output", help="Directory to save the predictions")

...
echo "=========="
echo "----- Predicting Test -----"
python3 predict.py --test-dataset ../../data/test-english/ --model-name Baseline --filter-1-dir ../openness-vs-conservation/output/ --filter-1-model Lex-LIWC-22_LingFeat --filter-1-th 0.82
echo "----- Evaluating Test -----"
...
echo "=========="
echo "----- Predicting Test -----"
python3 predict.py --test-dataset ../../data/test-english/ --model-name NER --ner-features --filter-1-dir ../openness-vs-conservation/output/ --filter-1-model Lex-LIWC-22_LingFeat --filter-1-th 0.82
echo "----- Evaluating Test -----"
...
echo "=========="
echo "----- Predicting Test -----"
python3 predict.py --test-dataset ../../data/test-english/ --model-name Lex-MJD --lexicon MJD --filter-1-dir ../openness-vs-conservation/output/ --filter-1-model Lex-LIWC-22_LingFeat --filter-1-th 0.82
echo "----- Evaluating Test -----"
...
echo "=========="
echo "----- Predicting Test -----"
python3 predict.py --test-dataset ../../data/test-english/ --model-name TD-LDA --topic-detection lda --filter-1-dir ../openness-vs-conservation/output/ --filter-1-model Lex-LIWC-22_LingFeat --filter-1-th 0.82
echo "----- Evaluating Test -----"
...
echo "=========="
echo "----- Predicting Test -----"
python3 predict.py --test-dataset ../../data/test-english/ --model-name NER_TD-LDA --ner-features --topic-detection lda --filter-1-dir ../openness-vs-conservation/output/ --filter-1-model Lex-LIWC-22_LingFeat
echo "----- Evaluating Test -----"
...
echo "=========="
echo "----- Predicting Test -----"
python3 predict.py --test-dataset ../../data/test-english/ --model-name NER_TD-LDA --ner-features --topic-detection lda --filter-1-dir ../openness-vs-conservation/output/ --filter-1-model Lex-LIWC-22_LingFeat --filter-1-th 0.82
echo "----- Evaluating Test -----"

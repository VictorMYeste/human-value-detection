...
def load_emotional_embeddings():
    ...
    vad_lexicon_path = "../../lexicons/NRC-VAD-Lexicon.txt"  # Update with your actual lexicon path
    vad_scores = {}
...
def load_dataset(directory, tokenizer, vad_scores, load_labels=True):
    sentences_file_path = os.path.join(directory, "sentences.tsv")
    labels_file_path = os.path.join(directory, "labels-cat.tsv")
...
training_dataset, training_text_ids, training_sentence_ids = load_dataset(args.training_dataset, tokenizer, vad_scores)

# Load the validation dataset
validation_dataset = training_dataset
if args.validation_dataset != None:
    validation_dataset, validation_text_ids, validation_sentence_ids = load_dataset(args.validation_dataset, tokenizer, vad_scores)

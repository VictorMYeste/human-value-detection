# Baseline for ValueEval'24 (Script)
Baseline for the task on Human Value Detection, script version.
...
## Usage
If you trained your own model, change the `model_path` in `predict.py`.
...
# run
python3 predict.py ../../dataset/ output/

# example
python3 predict.py ../../data/test-english/ output/
